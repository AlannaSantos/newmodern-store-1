        ...
        <tr>
            <td align="center"
                ...
                <table class="content" width="100%" cellpadding="0" cellspacing="0" role="presentation"
                    ...
                    <tr>
                        <img src="{{ public_path('backend/images/logo/logo.png') }}" width="150px" heigh="200px"
                            class="" alt=""
                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <p
                                            ...
                                            A equipe NewModern agradece a sua compra.
                                            Logo, logo os seus produtos chegarão no endereço informado por você na hora
                                            da compra.</p>
                                                        ...
                                                        <tr>
                                                            <td align="left"
                                                                ...
                                                                <table border="0" cellpadding="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        <td>Fatura: {{ $order['invoice_no'] }}</td>
                                                                    </tr>

                                                                    <tr>
                                                                        <td>Data da compra: {{ $order['order_date'] }}
                                                                        </td>
                                                                    </tr>

                                                                    <tr>
                                                                        <td>Valor total: R$ {{ $order['amount'] }}.00
                                                                        </td>
                                                                    </tr>
                                                        ...
                                                        <tr>
                                                            <td align="left"
                                                                ...
                                                                <table border="0" cellpadding="0" cellspacing="0"
                                                                    ...
                                                                    <h4 class>ENDEREÇO DE ENTREGA</h4>

                                                                    <tr>
                                                                        <td>Rua: {{ $order['shipping_street'] }}</td>
                                                                    </tr>

                                                                    <tr>
                                                                        <td>Numero: {{ $order['shipping_number'] }}</td>
                                                                    </tr>

                                                                    <tr>
                                                                        <td>Bairro: {{ $order['shipping_hood'] }}</td>
                                                                    </tr>

                                                                    <tr>
                                                                        <td>Cidade: {{ $order['shipping_district_id'] }}
                                                                        </td>
                                                                    </tr>

                                                                    <tr>
                                                                        <td>Estado: {{ $order['shipping_division_id'] }}
                                                                        </td>
                                                                    </tr>

                                                                    <tr>
                                                                        <td>CEP: {{ $order['postal_code'] }}</td>
                                                                    </tr>

                                                                    <tr>
                                                                        <td>Observações: {{ $order['notes'] }}</td>
                                                                    </tr>
                ...
                <p
                    style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                    A sua compra chegará em até 30 dias úteis (pensar em termos de envio...).</p>
                <p
                    style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                    Verifique o seu endereço. Qualquer divergência, entre em contato com a
                    equipe NewModern.</p>
                <p
                    style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                    Abraços!<br>
                                                    ...
                                                    <p
                                                        ...
                                                        into your web browser: <span class="break-all"
                                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; word-break: break-all;"><a
                                                                href="http://127.0.0.1:8000/reset-password/7cec93aca193765e205c95b97568c86e32602010a86453067a977d09e637e6fc?email=lucas%40gmail.com"
                                                                style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; color: #3869d4;">http://127.0.0.1:8000/reset-password/7cec93aca193765e205c95b97568c86e32602010a86453067a977d09e637e6fc?email=lucas%40gmail.com</a></span>
                                                    </p>
                ...
                <tr>
                    <td class="content-cell" align="left"
                        ...
                        <p
                            ...
                            © 2022 NewModern. Todos os direitos reservados.</p>
